...
.rp-tab{font-size:13px;letter-spacing:3px;text-transform:uppercase;color:var(--stone);padding:18px 28px;cursor:pointer;border:none;background:none;border-bottom:2px solid transparent;margin-bottom:-1px;transition:color .2s,border-color .2s;}
...
.rp-total{font-size:13px;letter-spacing:2px;text-transform:uppercase;padding:18px 0;}
