...
.hero-subline{font-size:18px;font-weight:300;letter-spacing:.25px;color:var(--mist);line-height:1.6;margin-bottom:30px;max-width:500px;animation:fadeUp .8s ease .9s both;}
