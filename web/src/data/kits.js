...
export const KITS = [
  ...
  },
  {
    ...
    tagline: 'The complete ritual. A proper daily clean head to toe, plus the weekly oil step used through the clay mix, scalp and damp skin. The deep ritual most men wish they had started with.',
    outcome: 'Not just clean. Properly fed.',
    chooser: 'Everything in GROUND + organic argan oil for the clay mix, scalp and damp skin. Where most men start.',
    popular: true,
    comingSoon: false,
  },
  {
