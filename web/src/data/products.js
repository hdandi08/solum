export const PRODUCTS = [
  ...
  },
  {
    ...
    benefits: [
      ...
      'Lasts ~4 weeks with daily use · 100% viscose · Korean bathhouse tradition',
    ],
    desc: 'Smoother skin and less body odour — from the first use. Dead skin cells build up on the surface and never shed on their own. That\'s the dullness, the rough patches, the bumps — and it\'s also where odour-causing bacteria live and multiply. A regular shower wets the surface. This mitt physically removes it. Korean bathhouses have used 100% viscose mitts for generations to lift this layer on warm, wet skin. You\'ll see it roll off the first time. When the bacteria have nothing to feed on, the smell goes with it. Lasts around 4 weeks with daily use.',
