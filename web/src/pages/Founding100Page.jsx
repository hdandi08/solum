...
.f1-nav-meta{font-size:11px;letter-spacing:3px;text-transform:uppercase;color:rgba(240,236,226,0.4);font-weight:600;}
.f1-nav-signout{font-size:11px;letter-spacing:3px;text-transform:uppercase;color:rgba(240,236,226,0.35);background:none;border:none;cursor:pointer;padding:0;font-family:inherit;transition:color .2s;}
...
.f1-login-sub{font-size:14px;font-weight:300;color:rgba(240,236,226,0.5);margin-bottom:24px;text-align:center;line-height:1.5;}
.f1-input{width:100%;background:#181C24;border:1px solid rgba(240,236,226,0.1);color:#F0ECE2;padding:14px 16px;font-family:'Barlow Condensed',sans-serif;font-size:16px;outline:none;transition:border-color .2s;box-sizing:border-box;}
...
.f1-btn-ghost{width:100%;background:transparent;color:rgba(240,236,226,0.45);border:1px solid rgba(240,236,226,0.1);font-family:'Barlow Condensed',sans-serif;font-size:13px;letter-spacing:2px;text-transform:uppercase;padding:12px;cursor:pointer;margin-top:8px;transition:border-color .2s,color .2s;}
...
.f1-not-member{font-size:14px;color:rgba(240,236,226,0.45);text-align:center;margin-top:20px;line-height:1.6;}
...
.f1-sent-body{font-size:15px;font-weight:300;color:rgba(240,236,226,0.6);line-height:1.65;margin-bottom:28px;}
...
.f1-pledge-section-label{font-size:10px;letter-spacing:5px;text-transform:uppercase;font-weight:700;color:rgba(240,236,226,0.3);margin-bottom:16px;}
.f1-pledge-list{list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:12px;}
.f1-pledge-item{display:flex;align-items:flex-start;gap:14px;font-size:15px;font-weight:300;color:rgba(240,236,226,0.75);line-height:1.55;}
...
.f1-pledge-exit{font-size:13px;font-weight:300;color:rgba(240,236,226,0.4);line-height:1.6;}
.f1-pledge-exit strong{color:rgba(240,236,226,0.6);font-weight:600;}
.f1-pledge-check-row{display:flex;align-items:flex-start;gap:14px;margin-bottom:24px;cursor:pointer;}
.f1-pledge-checkbox{width:18px;height:18px;border:1px solid rgba(240,236,226,0.3);background:transparent;flex-shrink:0;margin-top:2px;display:flex;align-items:center;justify-content:center;transition:border-color .2s,background .2s;}
.f1-pledge-checkbox.checked{background:#2E6DA4;border-color:#2E6DA4;}
.f1-pledge-check-label{font-size:15px;font-weight:400;color:rgba(240,236,226,0.8);line-height:1.5;}
...
.f1-welcome-date{font-size:13px;font-weight:300;color:rgba(240,236,226,0.4);letter-spacing:.5px;}
...
.f1-status-inactive{background:rgba(168,180,188,0.1);color:rgba(240,236,226,0.35);}
...
.f1-part-stat{}
.f1-part-label{font-size:10px;letter-spacing:4px;text-transform:uppercase;font-weight:600;color:rgba(240,236,226,0.3);margin-bottom:3px;}
...
.f1-part-note{font-size:12px;font-weight:300;color:rgba(240,236,226,0.35);margin-top:6px;letter-spacing:.3px;}

/* Section label */
.f1-section-label{font-size:10px;letter-spacing:6px;text-transform:uppercase;font-weight:700;color:rgba(240,236,226,0.25);margin-bottom:14px;}
...
.f1-job-tag-done{color:rgba(74,143,199,0.55);}
.f1-job-title{font-family:'Bebas Neue',sans-serif;font-size:22px;letter-spacing:.05em;color:#F0ECE2;}
.f1-job-desc{font-size:13px;font-weight:300;color:rgba(240,236,226,0.45);margin-top:3px;line-height:1.5;}
.f1-job-pts{font-size:11px;letter-spacing:2px;text-transform:uppercase;font-weight:600;color:rgba(240,236,226,0.3);flex-shrink:0;}
.f1-job-chevron{font-size:16px;color:rgba(240,236,226,0.25);transition:transform .2s;flex-shrink:0;}
...
.f1-q-label{font-size:10px;letter-spacing:4px;text-transform:uppercase;font-weight:600;color:rgba(240,236,226,0.3);margin-bottom:8px;}
...
.f1-option{display:flex;align-items:center;gap:12px;cursor:pointer;padding:10px 14px;border:1px solid rgba(240,236,226,0.07);transition:border-color .15s,background .15s;}
.f1-option:hover{border-color:rgba(240,236,226,0.15);}
.f1-option.selected{border-color:rgba(74,143,199,0.5);background:rgba(74,143,199,0.06);}
.f1-option-box{width:16px;height:16px;border:1px solid rgba(240,236,226,0.25);flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:background .15s,border-color .15s;}
.f1-option.selected .f1-option-box{background:#2E6DA4;border-color:#2E6DA4;}
.f1-option-radio{border-radius:50%;}
.f1-option-label{font-size:14px;font-weight:400;color:rgba(240,236,226,0.8);}
.f1-other-input{width:100%;background:#08090B;border:1px solid rgba(240,236,226,0.1);color:#F0ECE2;padding:10px 14px;font-family:'Barlow Condensed',sans-serif;font-size:14px;outline:none;margin-top:8px;box-sizing:border-box;transition:border-color .2s;}
.f1-other-input:focus{border-color:#2E6DA4;}

/* Textarea */
.f1-textarea{width:100%;background:#181C24;border:1px solid rgba(240,236,226,0.09);color:#F0ECE2;padding:14px 16px;font-family:'Barlow Condensed',sans-serif;font-size:15px;font-weight:300;outline:none;resize:vertical;min-height:80px;line-height:1.5;box-sizing:border-box;transition:border-color .2s;}
...
.f1-submit-note{font-size:13px;font-weight:300;color:rgba(240,236,226,0.35);flex:1;}
...
/* Done state */
.f1-done-note{display:flex;align-items:center;gap:10px;font-size:13px;font-weight:400;color:rgba(74,143,199,0.8);margin-top:20px;}
.f1-response-view{margin-top:4px;}
.f1-response-q{font-size:11px;letter-spacing:2px;text-transform:uppercase;font-weight:600;color:rgba(240,236,226,0.3);margin-bottom:5px;margin-top:20px;}
.f1-response-a{font-size:14px;font-weight:300;color:rgba(240,236,226,0.65);line-height:1.55;padding-left:12px;border-left:2px solid rgba(74,143,199,0.25);}
...
.f1-record-sub{font-size:14px;font-weight:300;color:rgba(240,236,226,0.45);line-height:1.6;margin-bottom:24px;}
.f1-record-empty{text-align:center;padding:28px 0;border-top:1px solid rgba(240,236,226,0.05);}
.f1-record-empty-text{font-size:13px;font-weight:300;color:rgba(240,236,226,0.3);line-height:1.7;}
...
.f1-inactive-body{font-size:15px;font-weight:300;color:rgba(240,236,226,0.5);line-height:1.65;margin-bottom:24px;}

.f1-divider{border:none;border-top:1px solid rgba(240,236,226,0.05);margin:36px 0;}
.f1-loading{min-height:100vh;display:flex;align-items:center;justify-content:center;font-size:11px;letter-spacing:4px;text-transform:uppercase;color:rgba(240,236,226,0.25);font-family:'Barlow Condensed',sans-serif;}
.f1-back{font-size:12px;letter-spacing:3px;text-transform:uppercase;color:rgba(240,236,226,0.3);text-decoration:none;display:inline-block;margin-top:20px;}
.f1-back:hover{color:rgba(240,236,226,0.7);}
