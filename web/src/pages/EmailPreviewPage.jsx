          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0ddd6;">
            ...
            <tr><td style="padding:16px 20px;border-bottom:1px solid #e0ddd6;">
              <table width="100%" cellpadding="0" cellspacing="0"><tr>
                ...
                <td><p style="margin:0 0 4px;font-size:14px;font-weight:600;color:#08090B;">Ships within one working day</p><p style="margin:0;font-size:13px;color:#777;line-height:1.5;">Your full ${kitName} Kit, shower essentials and refills. Order before 6 PM and it ships the next working day, Royal Mail Tracked 48. You'll get a tracking email when it's on its way.</p></td>
              </tr></table>
            </td></tr>
            ${step3}
