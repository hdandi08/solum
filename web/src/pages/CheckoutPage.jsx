...
.co-label .co-opt{font-size:10px;letter-spacing:1px;text-transform:none;opacity:.6;font-weight:300;margin-left:6px;}
...
.co-optional-label{font-size:12px;color:var(--stone);font-weight:300;margin-bottom:4px;opacity:.7;}
...
export default function CheckoutPage() {
  ...
  async function handleSubmit(e) {
    ...
    if (form.birth_year && (form.birth_year < 1940 || form.birth_year > 2006)) { setError('Birth year must be between 1940 and 2006.'); return; }
    if (form.birth_month && (form.birth_month < 1 || form.birth_month > 12)) { setError('Birth month must be between 1 and 12.'); return; }
      ...
      <div className="co-page">
        ...
        <div className="co-left">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="co-optional-label">Optional — helps us understand who we're building for</div>
            <div className="co-row">
              <div className="co-field">
                <label className="co-label">Birth Year <span className="co-opt">optional</span></label>
                <input className="co-input" type="number" min="1940" max="2006" value={form.birth_year} onChange={set('birth_year')} placeholder="1990" />
              </div>
              <div className="co-field">
                <label className="co-label">Birth Month <span className="co-opt">optional</span></label>
