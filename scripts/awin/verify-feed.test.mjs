...
const csv = [
  header,
  'ground,GROUND,"Daily ritual line one\nwith a ""quoted"" detail",https://example.test/ground.jpg,65.00,GBP,https://example.test/buy?kit=ground,1,SOLUM,Body Care,0.00',
  'ritual,RITUAL,"Weekly ritual",https://example.test/ritual.jpg,85.00,GBP,https://example.test/buy?kit=ritual,0,SOLUM,Body Care,0.00',
].join('\r\n')
...
test('rejects malformed row widths', () => {
  const malformed = [
    ...
    'ritual,RITUAL,x,x,85.00,GBP,x,1,SOLUM,x',
  ].join('\n')
